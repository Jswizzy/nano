...
import com.arrowmaker.proxy.model.nanoMessage.Main
import com.arrowmaker.proxy.model.nanoMessage.P3
...
class NanoDecoderTest {
    ...
    fun `Nano to message`() {
        ...
        val input = DatagramPacket(buf.duplicate(), InetSocketAddress(8888))
